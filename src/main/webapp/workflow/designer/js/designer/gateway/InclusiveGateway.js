draw2d.InclusiveGateway=function(par){
	var defaultPar={width:40,height:40};
	par=jq.extend(defaultPar,par||{}); 
	draw2d.ResizeImage.call(this,par._url);
	...
	this.setDimension(par.width,par.height);
};
draw2d.InclusiveGateway.prototype=new draw2d.ResizeImage();
...
draw2d.InclusiveGateway.prototype.toXML=function(){
	...
	if(newName != null && newName != "")
		name = newName;
	var xml='<inclusiveGateway id="'+this.gatewayId+'" name="'+name+'"></inclusiveGateway>\n';
	return xml;
};
